    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white font-sans">
      <div className="max-w-md w-full p-8 bg-gray-800 rounded-xl shadow-2xl border border-gray-700">
        ...
        <button 
          ...
          disabled={loading} 
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-900 font-bold py-2.5 px-4 rounded mb-6 transition-colors"
        >
        ...
        <div className="flex items-center mb-6">
          ...
          <span className="flex-shrink-0 px-4 text-gray-400 text-xs uppercase">Or Secure Email</span>
          <div className="flex-grow border-t border-gray-600"></div>
        </div>
